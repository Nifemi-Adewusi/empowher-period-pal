...
import WomenEmpowermentStats from '@/components/WomenEmpowermentStats';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-rose-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-10 left-10 w-20 h-20 bg-pink-200 rounded-full opacity-40 animate-pulse"></div>
        <div className="absolute top-1/4 right-20 w-16 h-16 bg-purple-200 rounded-full opacity-50 animate-bounce"></div>
        <div className="absolute bottom-1/4 left-1/4 w-12 h-12 bg-rose-200 rounded-full opacity-60 animate-pulse"></div>
        <div className="absolute top-1/2 right-1/3 w-8 h-8 bg-yellow-200 rounded-full opacity-70 animate-bounce"></div>
      ...
      <div className="relative pt-16 pb-12 px-4">
        <div className="text-center max-w-4xl mx-auto">
          <div className="mb-8 relative">
            ...
            <div className="relative bg-white rounded-full p-6 inline-block shadow-2xl">
          ...
          {userData ? (
            <div className="space-y-8">
              <div className="relative">
                <h1 className="text-5xl sm:text-6xl font-bold bg-gradient-to-r from-pink-600 via-purple-600 to-rose-600 text-transparent bg-clip-text animate-fade-in">
            ...
            <div className="space-y-8">
              <h1 className="text-5xl sm:text-7xl font-bold bg-gradient-to-r from-pink-600 via-purple-600 to-rose-600 text-transparent bg-clip-text animate-fade-in leading-tight">
                Embrace Your Power,<br />
                Celebrate Your Cycle 🌸
              </h1>
              <p className="text-2xl text-gray-700 max-w-2xl mx-auto animate-fade-in font-medium">
                Join a community of queens who celebrate their femininity and track their wellness with joy and pride! 💖
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button 
                  className="px-10 py-6 text-xl bg-gradient-to-r from-pink-500 via-purple-500 to-rose-500 hover:from-pink-600 hover:via-purple-600 hover:to-rose-600 transition-all animate-fade-in shadow-2xl hover:shadow-pink-500/25 hover:scale-105 transform"
                ...
                <Button 
                  variant="outline"
                  className="px-10 py-6 text-xl border-2 border-pink-300 text-pink-600 hover:bg-pink-50 hover:border-pink-400 transition-all"
      ...
      <WomenEmpowermentStats />

      {/* Enhanced Features Grid */}
      <div className="py-20 px-4 relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold bg-gradient-to-r from-pink-600 to-purple-600 text-transparent bg-clip-text mb-4">
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <CardContent className="p-8 text-center relative">
                  ...
                  <div className={`mb-6 inline-block p-4 bg-gradient-to-r ${feature.color} bg-opacity-10 rounded-2xl group-hover:scale-110 transition-transform duration-300`}>
                    {feature.icon}
                  </div>
      ...
      {/* Call to Action */}
      <div className="py-20 px-4 bg-gradient-to-r from-pink-500 via-purple-500 to-rose-500 relative overflow-hidden">
        ...
        <div className="relative text-center max-w-4xl mx-auto text-white">
          ...
          <Button 
            className="px-12 py-6 text-xl bg-white text-purple-600 hover:bg-gray-100 transition-all shadow-2xl hover:scale-105 transform font-bold"
            onClick={() => navigate('/dashboard')}
          >
      ...
      {/* Footer */}
      <footer className="py-12 text-center bg-white/90 backdrop-blur-sm border-t border-pink-200">
