...
const Index: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Personalized self-care rituals for every phase of your cycle",
    ...
    },
    {
      ...
      description:
        "Track patterns and get insights that empower your health decisions",
    ...
    },
    {
      ...
      description:
        "Boost your confidence with cycle-synced motivational content",
    ...
    },
    {
      ...
      title: "Queen Mode",
      description:
        "Celebrate your power with achievements and milestone tracking",
    ...
    },
    {
      ...
      title: "Cycle Wisdom",
      description:
        "Learn about your body's natural rhythms and embrace your femininity",
          ...
          <div className="mb-6 sm:mb-8 relative">
            <div className="relative bg-white rounded-full p-4 sm:p-6 inline-block shadow-2xl">
              <div className="flex items-center gap-2">
                <Heart className="h-8 sm:h-12 w-8 sm:w-12 text-pink-500" />
          ...
          {userData ? (
            <div className="space-y-6 sm:space-y-8">
              <div className="relative">
                <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-pink-600 via-purple-600 to-rose-600 text-transparent bg-clip-text leading-tight">
            ...
            <div className="space-y-6 sm:space-y-8">
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold bg-gradient-to-r from-pink-600 via-purple-600 to-rose-600 text-transparent bg-clip-text leading-tight px-4">
                Embrace Your Power,
                <br />
                Celebrate Your Cycle 🌸
              </h1>
              <p className="text-lg sm:text-2xl text-gray-700 max-w-2xl mx-auto font-medium px-4">
                Join a community of queens who celebrate their femininity and
                track their wellness with joy and pride! 💖
              </p>

              <div className="flex flex-col sm:flex-row gap-4 justify-center px-4">
                <Button
                  className="px-6 sm:px-10 py-4 sm:py-6 text-lg sm:text-xl bg-gradient-to-r from-pink-500 via-purple-500 to-rose-500 hover:from-pink-600 hover:via-purple-600 hover:to-rose-600 transition-all shadow-2xl"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto px-4">
              Every feature is designed to honor your journey and empower your
              wellness decisions
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 sm:gap-8">
            {features.map((feature, index) => (
              <Card
                ...
                onClick={() => {
                  if (feature.title === "Smart Period Tracking") {
                    navigate("/settings");
                  }
                }}
              >
                ...
                <CardContent className="p-6 sm:p-8 text-center relative">
                  ...
                  <div
                    className={`mb-4 sm:mb-6 inline-block p-3 sm:p-4 bg-gradient-to-r ${feature.color} bg-opacity-10 rounded-2xl group-hover:scale-110 transition-transform duration-300`}
                  >
                    {feature.icon}
                  </div>
      ...
      <div className="py-12 sm:py-20 px-4 bg-gradient-to-r from-pink-500 via-purple-500 to-rose-500 relative overflow-hidden">
        ...
        <div className="relative text-center max-w-4xl mx-auto text-white">
          ...
          <p className="text-lg sm:text-xl mb-6 sm:mb-8 opacity-90 animate-fade-in px-4">
            Join thousands of women who have embraced their power and
            transformed their relationship with their cycle
          </p>
          <Button
