      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto px-4">
            Click anywhere to spread some love, track your mood, and get
            inspired! ✨
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <Card className="text-center border-none shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all hover:-translate-y-1">
            ...
            <CardContent>
              <p className="text-sm text-gray-600">
                Practice daily self-compassion and embrace your beautiful
                journey
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center border-none shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all hover:-translate-y-1">
            ...
            <CardContent>
              <p className="text-sm text-gray-600">
                Connect with your inner wisdom and find peace in every moment
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center border-none shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all hover:-translate-y-1">
            ...
            <CardContent>
              <p className="text-sm text-gray-600">
                Align your activities with your natural rhythms for optimal
                wellness
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center border-none shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all hover:-translate-y-1">
            ...
            <CardContent>
              <p className="text-sm text-gray-600">
                Track your progress and celebrate every step of your wellness
                journey
              </p>
            </CardContent>
          </Card>
